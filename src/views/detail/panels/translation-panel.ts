    ...
    render(body, ctx) {
      ...
      renderEnableToggle({
        ...
        help:
          ...
          "쓰고 고친 내용은 이어쓰기를 누르는 순간 스토리 원문 언어로 변환되어 원문에 " +
          "반영됩니다(그전까지는 대기 상태로 안전하게 보관 — 쓰는 도중에 AI 가 끼어들지 " +
          "않습니다). 내가 쓴 문장은 번역 화면에 그대로 남습니다. 채팅 세션에서는 " +
          "입력창의 메시지가 원문 언어로 변환되어 전송됩니다. 원문 언어는 지금까지의 " +
          "스토리를 보고 따라갑니다. 켜면 번역 용어집 자동 수집도 함께 동작합니다.",
      });
